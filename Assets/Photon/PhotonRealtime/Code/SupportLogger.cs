...
namespace Photon.Realtime
{
    ...
    #endif
    {
        ...
        public void OnRoomListUpdate(List<RoomInfo> _room_List)
        {
			Debug.Log(this.GetFormattedTimestamp() + " SupportLogger OnRoomListUpdate(roomList). roomList.Count: " + _room_List.Count);
        }
